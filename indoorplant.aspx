<%@ Page Title="" Language="C#" MasterPageFile="~/user master page.master" AutoEventWireup="true" CodeFile="indoorplant.aspx.cs" Inherits="indoorplant" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="zoomer/js-image-slider.css" rel="stylesheet" />
    <script src="zoomer/js-image-slider.js"></script>
    <style>
         .image1 {
            opacity: 1;
            display: block;
