...
public partial class pebbles : System.Web.UI.Page
{
    ...
    protected void showfillindoorplant()
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("select  id,pe_ID,SUBSTRING(pe_name,0,22)+ '...' as pe_name , convert(int,pe_price) as pe_price,pe_qty,img_url from pebbles_details", con);
