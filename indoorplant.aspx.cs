...
public partial class indoorplant : System.Web.UI.Page
{
    ...
    protected void showfillindoorplant()
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("select plant_details.plantID, SUBSTRING(pl_name,0,22)+'....' as pl_name,pl_qty, convert(varchar(10),pl_price) as pl_price,pl_category,(select top 1 imgUrl from plant_image where plant_details.plantID=plant_image.plantID) as imgurl from plant_details where pl_category='InDoor Plant'", con);
