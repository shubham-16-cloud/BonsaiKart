<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_master page.master" AutoEventWireup="true" CodeFile="edit_fertilizer.aspx.cs" Inherits="Admin_edit_fertilizer" %>
                ...
                <div class="container">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblid" runat="server" CssClass="col-md-2 control-label" Text="Fertilizer ID :-"></asp:Label>
                            <div class="col-md-3">
                                <asp:TextBox ID="txtid" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required Field" ControlToValidate="txtname" ValidationGroup="1"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblfertilizer" runat="server" CssClass="col-md-2 control-label" Text="Image :-"></asp:Label>
                            <div class="col-md-3">
                                <asp:Image ID="imgfertilizer" runat="server" />
                                <br /><asp:LinkButton ID="lbdelete" runat="server" OnClick="lbdelete_Click"  CommandName="delete" CssClass=" delbtn btn-danger">Delete</asp:LinkButton>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <br />
                                <asp:Button ID="btnedit" runat="server" ValidationGroup="1" OnClick="btnedit_Click" Text="Update Fertilizer" CssClass="btn btn-default" />
