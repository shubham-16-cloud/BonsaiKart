<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_master page.master" AutoEventWireup="true" CodeFile="Add_pebbles.aspx.cs" Inherits="Admin_Add_pebbles" %>
                ...
                <div class="container">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txtfeature" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                <br />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txtuse" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                <br />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <br />
                                <asp:Button ID="btnAdd" runat="server" ValidationGroup="1" OnClick="btnAdd_Click" Text="Add Pebbles" CssClass="btn btn-default" />
                            </div>
                        </div>
