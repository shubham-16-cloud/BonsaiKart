...
public partial class Admin_orderviwe : System.Web.UI.Page
{
   ...
   //         int rowcount = 0;
   //         DataRow r1;
   //          string StrSql = "select userid, orderid,orderdate from   order_master where CONVERT(varchar(10),orderdate,111) between '" + d1 + "' and '" + d2 + "'  ";
   ...
   //     string StrSql = "select count(*) as OCount from order_details,order_master where order_master.orderid = order_details.orderid and CONVERT(varchar(10),orderdate,111) between '" + d1 + "' and '" + d2 + "' group by order_details.orderID";
