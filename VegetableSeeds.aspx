<%@ Page Title="" Language="C#" MasterPageFile="~/user master page.master" AutoEventWireup="true" CodeFile="VegetableSeeds.aspx.cs" Inherits="VegetableSeeds" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <style>
        ...
        .bakground {
           ...
           background-image: url(../image/553163121.jpg);
            color: CYAN;
        ...
        <ContentTemplate>
            <div>
                ...
                <div class="container">
                    ...
                    <br />
                    <br />
                    <asp:ListView ID="ListView1" runat="server" DataKeyNames="seedID" OnItemDataBound="ListView1_ItemDataBound">
                        <AlternatingItemTemplate>
                            <div id="alttwo" class="col-md-3 col-sm-4 col-xs-6 text-center">
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#Eval("seedID" , "productdetail_page.aspx?seedID={0}") %>' Font-Underline="False">
                                    <div class="thumbnail">

                                        <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("se_imgurl") %>' CssClass="img-responsive margintop image1" Height="200px" Width="200px" />

                                        <asp:Label ID="pl_nameLabel" runat="server" Text='<%# Eval("se_name") %>' CssClass="listname" />
                                        <br />
                                        <asp:Label ID="pl_priceLabel" runat="server" Text='<%# Eval("se_price") %>' />₹
                                        <br />
                                        <asp:Label ID="lblqty" runat="server" Visible="false" Text='<%# Eval("se_qty") %>' />
                                        <asp:Label ID="lblplantid" runat="server" Visible="false" Text='<%# Eval("seedID") %>' />
