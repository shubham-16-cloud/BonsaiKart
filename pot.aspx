<%@ Page Title="" Language="C#" MasterPageFile="~/user master page.master" AutoEventWireup="true" CodeFile="pot.aspx.cs" Inherits="pot" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <style>
        ...
        .bakground {
            ...
            background-image: url(../image/98131310.jpg);
            color: red;
        ...
        <ContentTemplate>
             <div>
                ...
                <div class="container">
                    ...
                    <br />
                    <br />
                    <asp:ListView ID="ListView1" runat="server" DataKeyNames="potid" OnItemDataBound="ListView1_ItemDataBound">
                        <AlternatingItemTemplate>
                            <div id="alttwo" class="col-md-3 col-sm-4 col-xs-6 text-center">
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#Eval("potid" , "productdetail_page.aspx?potid={0}") %>' Font-Underline="False">
                                    <div class="thumbnail">

                                        <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("po_imgURL") %>' CssClass="img-responsive margintop image1" Height="200px" Width="200px" />

                                        <asp:Label ID="pl_nameLabel" runat="server" Text='<%# Eval("po_name") %>' CssClass="listname" />
                                        <br />
                                        <asp:Label ID="pl_priceLabel" runat="server" Text='<%# Eval("po_price") %>' />₹
                                        <br />
                                        <asp:Label ID="lblqty" runat="server" Visible="false" Text='<%# Eval("po_qty") %>' />
                                        <asp:Label ID="lblplantid" runat="server" Visible="false" Text='<%# Eval("potid") %>' />
