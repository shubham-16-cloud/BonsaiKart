...
public partial class TreeSeed : System.Web.UI.Page
{
    ...
    protected void showfillindoorplant()
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("select  id,seedID,SUBSTRING(se_name,0,22)+ '...' as se_name ,  convert(varchar(10),se_price) as se_price,se_qty,se_imgURL from seed_details where se_category= 'Tree Seeds'", con);
