<%@ Page Title="" Language="C#" MasterPageFile="~/user master page.master" AutoEventWireup="true" CodeFile="fertilizer.aspx.cs" Inherits="fertilizer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        ...
        .bakground {
            ...
            background-image: url(../image/93478217.jpg);
            color: black;
        ...
        <ContentTemplate>
            <div>
                ...
                <div class="container">
                    ...
                    <br />
                    <br />
                    <asp:ListView ID="ListView1" runat="server" DataKeyNames="fe_ID" OnItemDataBound="ListView1_ItemDataBound">
                        <AlternatingItemTemplate>
                            <div id="alttwo" class="col-md-3 col-sm-4 col-xs-6 text-center">
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#Eval("fe_ID" , "productpage_pebble_fertilizer.aspx?fe_ID={0}") %>' Font-Underline="False">
                                    <div class="thumbnail">

                                        <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("img_url") %>' CssClass="img-responsive margintop image1" Height="200px" Width="200px" />

                                        <asp:Label ID="pl_nameLabel" runat="server" Text='<%# Eval("fe_name") %>' CssClass="listname" />
                                        <br />
                                        <asp:Label ID="pl_priceLabel" runat="server" Text='<%# Eval("fe_price") %>' />₹
                                        <br />
                                        <asp:Label ID="lblqty" runat="server" Visible="false" Text='<%# Eval("fe_qty") %>' />
                                        <asp:Label ID="lblplantid" runat="server" Visible="false" Text='<%# Eval("fe_ID") %>' />
