...
public partial class pot : System.Web.UI.Page
{
    ...
    protected void showfillindoorplant()
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("select   id,potid,SUBSTRING(po_name,1,22)+ '...' as po_name, convert(varchar(10),po_price)as po_price,po_qty,po_imgURL from pot_details", con);
    ...
    private string[] cheakdiscountdate(string pid, int oPrice)
    {
        ...
        try
        {
            ...
            if (dr.HasRows)
            {
                ...
                discountedpriceAndDiscountRate[1] = ((oPrice * Convert.ToInt32(discountedpriceAndDiscountRate[0])) / 100).ToString();
